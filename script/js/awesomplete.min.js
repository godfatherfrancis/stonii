...
!function() {
    ...
    function e(t, e, i) {
        for (var n in e) {
            ...
            "number" == typeof s ? t[n] = parseInt(r) : !1 === s ? t[n] = null !== r : s instanceof Function ? t[n] = null : t[n] = r,
        ...
        this.isOpened = !1,
            ...
            this._events = {
                input: {
                    ...
                    keydown: function(t) {
                        var e = t.keyCode;
                        s.opened && (13 === e && s.selected ? (t.preventDefault(),
                            s.select()) : 27 === e ? s.close({
                            reason: "esc"
    ...
    r.prototype = {
        ...
        select: function(t, e) {
            if (t ? this.index = i.siblingIndex(t) : t = this.ul.children[this.index],
                    t) {
        ...
        evaluate: function() {
            var e = this
                , i = this.input.value;
            i.length >= this.minChars && this._list.length > 0 ? (this.index = -1,
                this.ul.innerHTML = "",
    ...
    i.create = function(t, e) {
        ...
        for (var s in e) {
            ...
            if ("inside" === s)
                ...
                s in n ? n[s] = r : n.setAttribute(s, r)
        }
        return n
    }
        ,
